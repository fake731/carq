...
import { Car, Clock, DollarSign, Wrench, CheckCircle2, Eye, Package, Bell, Loader2, Plus, X, Send, Image as ImageIcon } from "lucide-react";
              ...
              {notifications.map((notif) => (
                <div
                  ...
                  className={`rounded-2xl p-4 cursor-pointer transition-all ${
                    notif.read ? "bg-surface-2" : "bg-primary/5 border border-primary/15 hover:bg-primary/10"
                  }`}
                >
